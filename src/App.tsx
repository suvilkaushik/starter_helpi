  ...
  return (
    ...
    <Routes>
      ...
      <div className="quizButtonContainer">
        ...
        <p>Designed to help you explore various career options based on your interests, skills, and personality traits. The quiz consists of multiple-choice questions with straightforward options related to different fields and professions. The goal is to provide you with a general idea of potential career paths that align with your preferences.</p>
        ...
        <p>Evaluates your interests, strengths, values, skills, and career goals. It includes a combination of multiple-choice, open-ended, and situational questions to provide a thorough analysis of your suitability for various professions. The quiz also considers factors such as work-life balance, salary expectations, and career growth opportunities.</p>
